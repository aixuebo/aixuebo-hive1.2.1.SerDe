...
public final class ColumnProjectionUtils {
  ...
  public static final String READ_COLUMN_IDS_CONF_STR = "hive.io.file.readcolumn.ids";//要读取哪些属性列的序号
  public static final String READ_ALL_COLUMNS = "hive.io.file.read.all.columns";//是否读取全部属性列
  public static final String READ_COLUMN_NAMES_CONF_STR = "hive.io.file.readcolumn.names";//要读取哪些属性的name信息
